...
<li class="nav-item dropdown">
  ...
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="profil.php">Sejarah Singkat</a></li>
    <li><a class="dropdown-item" href="visi-misi.php">Visi & Misi</a></li>
    <li><a class="dropdown-item" href="perangkat.php">Kepala Desa & Perangkat</a></li>
  </ul>
</li>
...
<li class="nav-item dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" href="kelompok-tani.php">KELOMPOK TANI</a></li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="kontak.php">BUKU TAMU</a>
        </li>
